...
def test_data_loaded():
    ...
    # Checking the labels
    assert (os.path.exists(os.path.join(path,'labelled_training_data.csv'))), "Could not find the labelled training data csv-file"
    assert (os.path.exists(os.path.join(path,'labelled_test_data.csv'))), "Could not find the labelled test data csv-file"
